...
typedef enum BINARY_OPERATOR {
    ...
    BINARY_OP_EQ, BINARY_OP_GE,
    BINARY_OP_LE, BINARY_OP_NE,
    BINARY_OP_GT, BINARY_OP_LT,
...
// type of constant ex: 1, 3.3, "const string"
...
typedef enum STMT_KIND {
    ...
    // TODO: for simpler implementation, assign_expr also uses this
    ASSIGN_STMT,
    IF_STMT,
    FUNCTION_CALL_STMT,
    RETURN_STMT,
